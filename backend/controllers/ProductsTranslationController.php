...
use common\models\ProductTranslationSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ProductsTranslationController implements the CRUD actions for ProductTranslation model.
 */
class ProductsTranslationController extends Controller
{
    /**
     * @inheritDoc
     */
...
//        Utils::printAsError($products);
    ...
    {
        if (($model = ProductTranslation::findOne(['id' => $id])) !== null) {
            return $model;
        }
